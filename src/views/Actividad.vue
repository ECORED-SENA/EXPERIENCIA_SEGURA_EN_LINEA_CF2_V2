  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Legislación actual en delitos informáticos
        p.mb-4 Identificar las leyes que marcaron el inicio y evolución de la legislación colombiana en delitos informáticos. 
